...
import { RoleGuard } from 'src/api/auth/guard/roles.guard';
...
export class UserController {
  ...
  async register(
    ...
    try {
      ...
      return {
        message: 'User registered successfully. Kode OTP verifikasi registrasi telah dikirimkan ke email Anda.',
        data: response,
      };
    } catch (error) {
